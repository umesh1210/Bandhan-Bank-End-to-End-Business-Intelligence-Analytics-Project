...
An end-to-end data analytics and BI solution for Bandhan Bank, analyzing 
loan performance, customer segmentation, churn patterns, and regional growth trends.
...
| SSIS | ETL workflows & data loading |
